	...
	<tr>
	 ...
	 <s:iterator value="#request.WarningSecures">
              <tr>
              	...
              	<td>${warning_info}</td>  
              	<td>
              		<a href="WarningAction_edit.action?id=${id}&type=secure">修改</a>
              		<a href="Warning_delete.action?id=${id}" onclick="return checkdel();">报废</a>            		
              	</td> 
              </tr>
	</s:iterator>
</table>
   ...
   <table cellspacing="1"  class="table table-striped table-hover">
	...
	<s:iterator value="#request.WarningSecures">
              <tr>
              	...
              	<td>${warning_info}</td>  
              	<td>
              		<a href="WarningAction_edit.action?id=${id}">修改</a>
              		<a href="Warning_delete.action?id=${id}" onclick="return checkdel();">报废</a>            		
              	</td> 
              </tr>
	</s:iterator>
	...
	$.ajax({
        ...
        success: function(data) {
        	 ...
        	 var result = "<table class='table table-striped table-hover'>"; 
	             result += "<tr><th>时间</th><th>类型</th><th>子类型</th><th>安全等级</th><th>厂站名</th><th>装置名</th><th>对象名</th><th>安全信息</th><th>处理</th></tr>";  
	             for(var i=0;i<data.length;i++) {  
	                 ...
	                 result += "<td><a href='WarningAction_edit.action?id=${id}'>修改</a><a href='Warning_delete.action?id=${id}' onclick='return checkdel();'>报废</a></td>" ;
	                 result += "</tr>";  
	             }        	         	
	         result += "</table>"; 
             //alert(result);
