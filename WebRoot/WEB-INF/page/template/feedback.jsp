...
<body>
  <!-- <div class="alert alert-info">当前位置<b class="tip"></b>客户服务管理系统<b class="tip"></b>客户反馈管理</div> -->
  <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    <div class="panel panel-default">
      <div class="panel-heading" role="tab" id="heading1">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse1" aria-expanded="true" aria-controls="collapse1">
            <span class="glyphicon glyphicon-align-justify" aria-hidden="true"></span>&nbsp;&nbsp;客户反馈记录
          </a>
        </h4>
      </div>
      <div id="collapse1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading1">
        <div class="panel-body">
          ...
          <table class="table table-striped table-hover">
            ...
            <tbody>
              <s:iterator value="#request.feedback">
              <tr>
                <td>${type}</td>
              	<td>${name}</td>
              	<td>${feedbackname}</td>
     ...
     <div class="panel panel-default">
      <div class="panel-heading" role="tab" id="heading3">
        <h4 class="panel-title">
          <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse3" aria-expanded="false" aria-controls="collapse3">
            <span class="glyphicon glyphicon-align-justify" aria-hidden="true"></span>&nbsp;&nbsp;添加反馈记录
          </a>
        </h4>
      </div>
      <div id="collapse3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading3">
   	...
   	<div>
     <form action="feedbackAction_save.action" method="post">     
       <table align="center" border="1">
			...
			<tr align="center">
				<td align="right">反馈用户姓名:</td>
				<td align="left"><input type="text" name="feedbackname" /></td>
			</tr>
			<tr align="center">
				<td align="right">反馈日期:</td>
